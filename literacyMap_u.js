    ...
    function render(selection) {
      selection.each(function() {
        d3.select(this).html("<form>"+
                             "<input type='radio' name='gender' value='TotalSingle' checked> ALL<br>"+
                             "<input type='radio' name='gender' value='FemaleSingle'> FEMALE<br>"+
                             "<input type='radio' name='gender' value='MaleSingle'> MALE"+
                             "</form>");
      });
    } // render
return render;
