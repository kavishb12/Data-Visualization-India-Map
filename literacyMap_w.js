    ...
    function render(selection) {
      selection.each(function() {
        d3.select(this).html("<form>"+
                             "<input type='radio' name='gender' value='TotalWidowed' checked> ALL<br>"+
                             "<input type='radio' name='gender' value='FemaleWidowed'> FEMALE<br>"+
                             "<input type='radio' name='gender' value='MaleWidowed'> MALE"+
                             "</form>");
      });
    } // render
return render;
